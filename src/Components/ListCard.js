...
export default function ListCard(props) {
    return (
        <div class="card list-card w-100 px-lg-5 my-5  px-md-2 border-0 bg-transparent position-relative" >
            ...
            <div class="card-body shadow pt-5 pb-4 mx-lg-3 mx-md-2 text-center bg-light">
                {props.type == "campaign" && (
