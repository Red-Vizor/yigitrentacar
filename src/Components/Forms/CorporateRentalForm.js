                ...
                <div className=" mt-5 mb-5 px-lg-5 kisisel-bilgiler">
                    <form className="g-3">
                        <div className="input-group mb-3">
                            ...
                            <input type="email" className="form-control" id="inputEmail4" placeholder="Firma Adını Giriniz" />
                        </div>
                        <div className="row">
                            <div className="col-md-6">
                                <div className="input-group mb-3">
                                    ...
                                    <input type="email" className="form-control" id="inputEmail4" placeholder="Vergi Numarası*" />
                                </div>
                            </div>
                            <div className="col-md-6">
                                <div className="input-group mb-3">
                                    ...
                                    <input type="password" className="form-control" id="inputPassword4" placeholder="Araç Sayısı*" />
                                </div>
                            </div>
                            <div className="col-md-6">
                                <div className="input-group mb-3">
                                    ...
                                    <input type="password" className="form-control" id="inputPassword4" placeholder="İl*" />
                            ...
                            <div className="col-md-6">
                                <div className="input-group mb-3">
                                    ...
                                    <input type="password" className="form-control" id="inputPassword4" placeholder="İlçe*" />
                                </div>
                            </div>
                            <div className="col-md-6">
                                <div className="input-group mb-3">
                                    ...
                                    <input type="email" className="form-control" id="inputEmail4" placeholder="Yetkili Kişinin Adı" />
                                </div>
                            </div>
                            <div className="col-md-6">
                                <div className="input-group mb-3">
                                    ...
                                    <input type="password" className="form-control" id="inputPassword4" placeholder="Yetkili Kişinin Soyadı" />
                                </div>
                            </div>
                            <div className="col-md-6">
                                <div className="input-group mb-3">
                                    ...
                                    <input type="email" className="form-control" id="inputEmail4" placeholder="Telefon Numarası" />
                                </div>
                            </div>
                            <div className="col-md-6">
                                <div className="input-group mb-3">
                            ...
                            <div className="form-check mt-4 driver-policy">
                                <div className="row">
                            ...
                            <div className="mb-3 mt-4">
                                ...
                                <textarea className="form-control px-5" id="exampleFormControlTextarea1" placeholder="İLETMEK İSTEDİĞİNİZ MESAJINIZI BURAYA YAZABİLİRSİNİZ." rows="3"></textarea>
                            </div>
